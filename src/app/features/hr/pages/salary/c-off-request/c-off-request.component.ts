...
@Component({
  selector: 'app-c-off-request',
  templateUrl: './c-off-request.component.html',
  styleUrls: ['./c-off-request.component.scss']
})
export class COffRequestComponent implements OnInit{
  searchKeyword:any;
