...
@Component({
  selector: 'app-map-view-lightbox',
  templateUrl: './map-view-lightbox.component.html',
  styleUrls: ['./map-view-lightbox.component.scss']
})
export class MapViewLightboxComponent {
 routeid : any;
 fs_value : any;
 vehicle_id:any
...
overlay= new Overlay({
  ...
  /** map work  */
  ngOnInit(): void {
    console.log("check vehicle", this.vehicle_id.toString());
  ...
  initializeMap() {
    ...
    let payload = {
      id: this.vehicle_id == '' ? 0 : this.vehicle_id,
      ...
      // trip_start_date: '',
      // district: '',
      fs_value: this.fs_value == 0 ? this.fs_value : -1,
      // customer: '',
      // depo_name: '',
