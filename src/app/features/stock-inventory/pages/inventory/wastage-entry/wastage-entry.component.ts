...
@Component({
  selector: 'app-wastage-entry',
  templateUrl: './wastage-entry.component.html',
  styleUrls: ['./wastage-entry.component.scss']
})
export class WastageEntryComponent implements OnInit {
  ...
  initialTable() {
    this.tableData = [
      ...
      { key: 'keyValue', val: 'Sell. Qty' },
      { key: 'keyValue', val: 'Wastage Qty' },
      { key: 'keyValue', val: 'Adj.(+) Qty' },
      { key: 'keyValue', val: 'Adj.(-) Qty' },
      { key: 'keyValue', val: 'Balance Qty' },
